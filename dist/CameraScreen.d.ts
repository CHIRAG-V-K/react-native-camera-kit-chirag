...
export declare type Props = {
    ...
    zoomMode?: string;
    ratioOverlay?: string;
    backButtonImage?: any; // added by chirag
    backButtonImageStyle: ImageStyle; // added by chirag
    backButtonfunction: (event: any) => void; // added by chirag
    overlayDesign: (event: any) => void; // added by chirag
